  ...
  return (
    <div className="space-y-2">
      ...
      <input
        ...
        className={cn(
          'w-full rounded-lg border bg-card/60 px-3.5 py-2.5 text-sm text-foreground shadow-soft transition placeholder:text-muted/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#AAFF00]/50',
